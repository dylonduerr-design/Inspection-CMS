...
# Spec -> list of (detector, parser_module, parser_name, result_kind). First matching detector wins.
...
DISPATCH = {
    "P-401": [
        (ame_common.is_cores_report, ame_asphalt_cores, "ame_asphalt_cores", "core_compaction"),
        (ame_common.is_ame_report, ame_p401_hma, "ame_p401_hma", "hma_air_voids"),
    ],
    "P-403": [(ame_common.is_cores_report, ame_asphalt_cores, "ame_asphalt_cores", "core_compaction")],
    "P-610": [(isi_common.is_isi_report, isi_p610_concrete, "isi_p610_concrete", "concrete_strength")],
}
...
def run(pdf_path: str, spec_code: str) -> tuple[dict, int]:
    ...
    for detector, module, parser_name, result_kind in dispatch:
        if detector(text):
